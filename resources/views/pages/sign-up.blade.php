                ...
                <div class="col-md-6">
                    <div class="form-container p-3 rounded">
                        <form>
                            ...
                            <div class="input-group border py-1 rounded my-3">
                                <div class=" col-4 col-md-3">
                                    <select class="form-select form-select-sm border-0 col-4" aria-label=".form-select-lg example">
                                ...
                                <div class=" col-8 col-md-9">
                                    <input type="text" aria-label="First name" placeholder="Phone number" class="form-control border-0">
