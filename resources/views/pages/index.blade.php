        ...
        <div class="navy-bg py-5">
          <div class="container">
            ...
            <div class="container">
              ...
              <div class="card me-md-4 my-3" style="max-width: 18rem;">
                ...
                <div class="card border-0 sky-bg me-md-4 my-3" style="max-width: 18rem;">
                 ...
                 <div class="card border-0 sky-bg me-md-4 my-3" style="max-width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                        <span class="text-primary">Bliip</span> fetches the generated OTP and sends it to your customer’s registered mobile number.                        </p>
                   </div>
                 </div>
                 <div class="card border-0 sky-bg me-md-4 my-3" style="max-width: 18rem;">
                    <div class="bg-primary rounded-circle text-white" style="width:fit-content; padding:0.2rem 0.5rem; font-size:10px;">1</div>
