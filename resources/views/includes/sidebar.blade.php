    ...
    <div class="py-2">
        <a href="/dashboard">
            <div class="d-flex justify-content-center">
                <div class="d-flex px-3 py-2 rounded-pill align-items-center mb-3 side-btn navy-bg">
                    <!-- <a href=""> -->
        ...
        <a href="">
            <div class="d-flex justify-content-center">
                <div class="d-flex px-3 py-2 rounded-pill align-items-center mb-3 side-btn navy-border">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
